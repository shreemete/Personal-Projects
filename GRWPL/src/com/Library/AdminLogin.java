...
public class AdminLogin extends JFrame {
	...
	public AdminLogin() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(AdminLogin.class.getResource("/images/Logo1.jpg")));
		setResizable(false);
		...
		panel.setBounds(-1011, -575, 1406, 1123);
		contentPane.add(panel);
		
		JLabel label = new JLabel("");
		label.setBounds(new Rectangle(47, 23, 800, 900));
		label.setHorizontalAlignment(SwingConstants.CENTER);
		label.setIcon(new ImageIcon(AdminLogin.class.getResource("/images/library1.jpg")));
		panel.add(label);
		...
		JButton btnAminLogin = new JButton("Admin Login");
		...
		btnAminLogin.setForeground(new Color(153, 50, 204));
		btnAminLogin.setBackground(Color.WHITE);
		btnAminLogin.setBounds(562, 39, 187, 53);
		...
		textField.setBackground(new Color(106, 90, 205));
		...
		passwordField.setForeground(new Color(200, 200, 200));
		passwordField.setBackground(new Color(106, 90, 205));
		...
		btnBlack.setForeground(new Color(106, 90, 205));
